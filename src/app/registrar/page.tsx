...
import { FaCakeCandles, FaIdCard, FaLock } from "react-icons/fa6"
        ...
        <Flex align="center" justify="center" flex={1}>
            <Flex gap={4} flexDir="column" w="90vw" maxW="300px">
                ...
                <Box>
                    ...
                    <Input type="date" ref={birthDateRef} p={2} />
                </Box>
                <Box>
                    <Flex align="center" gap={2}>
                        <FaLock />
                ...
                <LoadingButton onClick={handleLogin} loading={loading} bgColor="blue.500" color="white" _hover={{bgColor: "blue.600"}}>Registrar</LoadingButton>
            </Flex>
        </Flex>
    </>
}